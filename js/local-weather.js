...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function getCoordinates(cityName) {
    const cityCoordinates = {
      ...
      Leh: { lat: 34.1526, lon: 77.5781 },
      Nainital: { lat: 29.3793, lon: 79.4549 },
      Mussoorie: { lat: 30.4405, lon: 78.1283 },
      Darjeeling: { lat: 27.031, lon: 88.6126 },
      Rishikesh: { lat: 30.0818, lon: 78.2676 },
